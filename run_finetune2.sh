...
# Copy files
cp -r /home/rishabhswapnil/arah-release/data/odp/CoreView_$subjectID/data_test_view1 /home/rishabhswapnil/3dgs3/data/ZJUMoCap/CoreView_$subjectID/

# Activate the 3dgs-avatar environment
conda activate 3dgs-finetuned
...
ffmpeg -framerate 10 -i render_c01_f%06d.png -c:v libx264 -pix_fmt yuv420p -r 10 finetune2_386_output.mp4
cp -r finetune2_output.mp4 /home/rishabhswapnil/Final-Output
cd ..
cd ..
cd ..
cd ..
